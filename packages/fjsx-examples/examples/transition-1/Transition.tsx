...
const updateStatus = (props: TransitionProps, mounting = false) => {
  ...
  } else if (props.unmountOnExit && props.status$.$val === EXITED) {
    props.status$ = fjsx.value(UNMOUNTED);
  }
};
...
export const Transition = (props: TransitionProps) => {
  ...
  let node = <div>{props.status$ ? childNodes() : null}</div>;
  return node;
};
