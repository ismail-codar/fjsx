// JSX type definitions for fjsx initially based on those for React v0.14 and Surplus (https://github.com/adamhaile/surplus) project.
...
declare namespace JSX {
  ...
  interface DOMAttributes<T> extends FjsxAtributes<T> {
    onDomCreate?: (node: HTMLElement) => void;
    // Clipboard Events
