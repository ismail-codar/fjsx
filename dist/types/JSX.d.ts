...
// Project: http://facebook.github.io/Fjsx/
...
Fjsx attributes, such as key and ref, should also be accepted in props, but should not exist on element.props.
The "correct" way to model this, then, is with:
declare function cloneElement<P extends Q, Q>(
    element: FjsxElement<P>,
    props?: Q & Attributes,
    ...children: FjsxNode[]): FjsxElement<P>;
...
var element: Fjsx.CElement<ButtonProps, Button>;
Fjsx.cloneElement(element, { label: "label" });
// cloning with optional props requires a cast
Fjsx.cloneElement(element, <{ isDisabled?: boolean }>{ isDisabled: true });
// cloning with key or ref requires a cast
Fjsx.cloneElement(element, <Fjsx.ClassAttributes<Button>>{ ref: button => button.reset() });
Fjsx.cloneElement(element, <{ isDisabled?: boolean } & Fjsx.Attributes>{
    key: "disabledButton",
    isDisabled: true
});
*/
...
export = Fjsx;
export as namespace Fjsx;

declare namespace Fjsx {
  //
  // Fjsx Elements
  // ----------------------------------------------------------------------
  ...
  interface FjsxElement<P> extends HTMLElement {
    props: P;
    key: Key | null;
  }
  ...
  //
  // Fjsx Nodes
  // http://facebook.github.io/Fjsx/docs/glossary.html
  // ----------------------------------------------------------------------

  type FjsxText = string | number;
  type FjsxChild = FjsxElement<any> | FjsxText;

  // Should be Array<FjsxNode> but type aliases cannot be recursive
  type FjsxFragment = {} | Array<FjsxChild | any[] | boolean>;
  type FjsxNode =
    | FjsxChild
    | FjsxFragment
    | string
  ...
  type FjsxEventHandler<T> = EventHandler<SyntheticEvent<T>>;
  ...
  interface DOMAttributes<T> {
    ...
    // Image Events
    onLoad?: FjsxEventHandler<T>;
    onLoadCapture?: FjsxEventHandler<T>;
    onError?: FjsxEventHandler<T>; // also a Media Event
    onErrorCapture?: FjsxEventHandler<T>; // also a Media Event
    ...
    // Media Events
    onAbort?: FjsxEventHandler<T>;
    onAbortCapture?: FjsxEventHandler<T>;
    onCanPlay?: FjsxEventHandler<T>;
    onCanPlayCapture?: FjsxEventHandler<T>;
    onCanPlayThrough?: FjsxEventHandler<T>;
    onCanPlayThroughCapture?: FjsxEventHandler<T>;
    onDurationChange?: FjsxEventHandler<T>;
    onDurationChangeCapture?: FjsxEventHandler<T>;
    onEmptied?: FjsxEventHandler<T>;
    onEmptiedCapture?: FjsxEventHandler<T>;
    onEncrypted?: FjsxEventHandler<T>;
    onEncryptedCapture?: FjsxEventHandler<T>;
    onEnded?: FjsxEventHandler<T>;
    onEndedCapture?: FjsxEventHandler<T>;
    onLoadedData?: FjsxEventHandler<T>;
    onLoadedDataCapture?: FjsxEventHandler<T>;
    onLoadedMetadata?: FjsxEventHandler<T>;
    onLoadedMetadataCapture?: FjsxEventHandler<T>;
    onLoadStart?: FjsxEventHandler<T>;
    onLoadStartCapture?: FjsxEventHandler<T>;
    onPause?: FjsxEventHandler<T>;
    onPauseCapture?: FjsxEventHandler<T>;
    onPlay?: FjsxEventHandler<T>;
    onPlayCapture?: FjsxEventHandler<T>;
    onPlaying?: FjsxEventHandler<T>;
    onPlayingCapture?: FjsxEventHandler<T>;
    onProgress?: FjsxEventHandler<T>;
    onProgressCapture?: FjsxEventHandler<T>;
    onRateChange?: FjsxEventHandler<T>;
    onRateChangeCapture?: FjsxEventHandler<T>;
    onSeeked?: FjsxEventHandler<T>;
    onSeekedCapture?: FjsxEventHandler<T>;
    onSeeking?: FjsxEventHandler<T>;
    onSeekingCapture?: FjsxEventHandler<T>;
    onStalled?: FjsxEventHandler<T>;
    onStalledCapture?: FjsxEventHandler<T>;
    onSuspend?: FjsxEventHandler<T>;
    onSuspendCapture?: FjsxEventHandler<T>;
    onTimeUpdate?: FjsxEventHandler<T>;
    onTimeUpdateCapture?: FjsxEventHandler<T>;
    onVolumeChange?: FjsxEventHandler<T>;
    onVolumeChangeCapture?: FjsxEventHandler<T>;
    onWaiting?: FjsxEventHandler<T>;
    onWaitingCapture?: FjsxEventHandler<T>;
    ...
    // Selection Events
    onSelect?: FjsxEventHandler<T>;
    onSelectCapture?: FjsxEventHandler<T>;
  ...
  // unitless numbers are listed here (see CSSProperty.js in Fjsx)
  ...
  // that Fjsx supports, but the types can be improved.
  // Full list here: https://facebook.github.io/Fjsx/docs/dom-elements.html
  //
  ...
  interface FjsxChildren {
    map<T>(children: FjsxNode, fn: (child: FjsxChild, index: number) => T): T[];
    forEach(
      children: FjsxNode,
      fn: (child: FjsxChild, index: number) => void
    ): void;
    count(children: FjsxNode): number;
    only(children: FjsxNode): FjsxElement<any>;
    toArray(children: FjsxNode): FjsxChild[];
  }
...
declare global {
  namespace JSX {
    // tslint:disable-next-line:no-empty-interface
    interface Element extends Fjsx.FjsxElement<any> {}
    ...
    // tslint:disable-next-line:no-empty-interface
    interface IntrinsicAttributes extends Fjsx.Attributes {}
    // tslint:disable-next-line:no-empty-interface
    interface IntrinsicClassAttributes<T> extends Fjsx.ClassAttributes<T> {}

    interface IntrinsicElements {
      // HTML
      a: Fjsx.DetailedHTMLProps<
        Fjsx.AnchorHTMLAttributes<HTMLAnchorElement>,
        HTMLAnchorElement
      >;
      abbr: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      address: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      area: Fjsx.DetailedHTMLProps<
        Fjsx.AreaHTMLAttributes<HTMLAreaElement>,
        HTMLAreaElement
      >;
      article: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      aside: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      audio: Fjsx.DetailedHTMLProps<
        Fjsx.AudioHTMLAttributes<HTMLAudioElement>,
        HTMLAudioElement
      >;
      b: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      base: Fjsx.DetailedHTMLProps<
        Fjsx.BaseHTMLAttributes<HTMLBaseElement>,
        HTMLBaseElement
      >;
      bdi: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      bdo: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      big: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      blockquote: Fjsx.DetailedHTMLProps<
        Fjsx.BlockquoteHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      body: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLBodyElement>,
        HTMLBodyElement
      >;
      br: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLBRElement>,
        HTMLBRElement
      >;
      button: Fjsx.DetailedHTMLProps<
        Fjsx.ButtonHTMLAttributes<HTMLButtonElement>,
        HTMLButtonElement
      >;
      canvas: Fjsx.DetailedHTMLProps<
        Fjsx.CanvasHTMLAttributes<HTMLCanvasElement>,
        HTMLCanvasElement
      >;
      caption: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      cite: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      code: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      col: Fjsx.DetailedHTMLProps<
        Fjsx.ColHTMLAttributes<HTMLTableColElement>,
        HTMLTableColElement
      >;
      colgroup: Fjsx.DetailedHTMLProps<
        Fjsx.ColgroupHTMLAttributes<HTMLTableColElement>,
        HTMLTableColElement
      >;
      data: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      datalist: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLDataListElement>,
        HTMLDataListElement
      >;
      dd: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      del: Fjsx.DetailedHTMLProps<
        Fjsx.DelHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      details: Fjsx.DetailedHTMLProps<
        Fjsx.DetailsHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      dfn: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      dialog: Fjsx.DetailedHTMLProps<
        Fjsx.DialogHTMLAttributes<HTMLDialogElement>,
        HTMLDialogElement
      >;
      div: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLDivElement>,
        HTMLDivElement
      >;
      dl: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLDListElement>,
        HTMLDListElement
      >;
      dt: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      em: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      embed: Fjsx.DetailedHTMLProps<
        Fjsx.EmbedHTMLAttributes<HTMLEmbedElement>,
        HTMLEmbedElement
      >;
      fieldset: Fjsx.DetailedHTMLProps<
        Fjsx.FieldsetHTMLAttributes<HTMLFieldSetElement>,
        HTMLFieldSetElement
      >;
      figcaption: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      figure: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      footer: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      form: Fjsx.DetailedHTMLProps<
        Fjsx.FormHTMLAttributes<HTMLFormElement>,
        HTMLFormElement
      >;
      h1: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      h2: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      h3: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      h4: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      h5: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      h6: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadingElement>,
        HTMLHeadingElement
      >;
      head: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHeadElement>,
        HTMLHeadElement
      >;
      header: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      hgroup: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      hr: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLHRElement>,
        HTMLHRElement
      >;
      html: Fjsx.DetailedHTMLProps<
        Fjsx.HtmlHTMLAttributes<HTMLHtmlElement>,
        HTMLHtmlElement
      >;
      i: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      iframe: Fjsx.DetailedHTMLProps<
        Fjsx.IframeHTMLAttributes<HTMLIFrameElement>,
        HTMLIFrameElement
      >;
      img: Fjsx.DetailedHTMLProps<
        Fjsx.ImgHTMLAttributes<HTMLImageElement>,
        HTMLImageElement
      >;
      input: Fjsx.DetailedHTMLProps<
        Fjsx.InputHTMLAttributes<HTMLInputElement>,
        HTMLInputElement
      >;
      ins: Fjsx.DetailedHTMLProps<
        Fjsx.InsHTMLAttributes<HTMLModElement>,
        HTMLModElement
      >;
      kbd: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      keygen: Fjsx.DetailedHTMLProps<
        Fjsx.KeygenHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      label: Fjsx.DetailedHTMLProps<
        Fjsx.LabelHTMLAttributes<HTMLLabelElement>,
        HTMLLabelElement
      >;
      legend: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLLegendElement>,
        HTMLLegendElement
      >;
      li: Fjsx.DetailedHTMLProps<
        Fjsx.LiHTMLAttributes<HTMLLIElement>,
        HTMLLIElement
      >;
      link: Fjsx.DetailedHTMLProps<
        Fjsx.LinkHTMLAttributes<HTMLLinkElement>,
        HTMLLinkElement
      >;
      main: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      map: Fjsx.DetailedHTMLProps<
        Fjsx.MapHTMLAttributes<HTMLMapElement>,
        HTMLMapElement
      >;
      mark: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      menu: Fjsx.DetailedHTMLProps<
        Fjsx.MenuHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      menuitem: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      meta: Fjsx.DetailedHTMLProps<
        Fjsx.MetaHTMLAttributes<HTMLMetaElement>,
        HTMLMetaElement
      >;
      meter: Fjsx.DetailedHTMLProps<
        Fjsx.MeterHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      nav: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      noindex: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      noscript: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      object: Fjsx.DetailedHTMLProps<
        Fjsx.ObjectHTMLAttributes<HTMLObjectElement>,
        HTMLObjectElement
      >;
      ol: Fjsx.DetailedHTMLProps<
        Fjsx.OlHTMLAttributes<HTMLOListElement>,
        HTMLOListElement
      >;
      optgroup: Fjsx.DetailedHTMLProps<
        Fjsx.OptgroupHTMLAttributes<HTMLOptGroupElement>,
        HTMLOptGroupElement
      >;
      option: Fjsx.DetailedHTMLProps<
        Fjsx.OptionHTMLAttributes<HTMLOptionElement>,
        HTMLOptionElement
      >;
      output: Fjsx.DetailedHTMLProps<
        Fjsx.OutputHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      p: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLParagraphElement>,
        HTMLParagraphElement
      >;
      param: Fjsx.DetailedHTMLProps<
        Fjsx.ParamHTMLAttributes<HTMLParamElement>,
        HTMLParamElement
      >;
      picture: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      pre: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLPreElement>,
        HTMLPreElement
      >;
      progress: Fjsx.DetailedHTMLProps<
        Fjsx.ProgressHTMLAttributes<HTMLProgressElement>,
        HTMLProgressElement
      >;
      q: Fjsx.DetailedHTMLProps<
        Fjsx.QuoteHTMLAttributes<HTMLQuoteElement>,
        HTMLQuoteElement
      >;
      rp: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      rt: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      ruby: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      s: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      samp: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      script: Fjsx.DetailedHTMLProps<
        Fjsx.ScriptHTMLAttributes<HTMLScriptElement>,
        HTMLScriptElement
      >;
      section: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      select: Fjsx.DetailedHTMLProps<
        Fjsx.SelectHTMLAttributes<HTMLSelectElement>,
        HTMLSelectElement
      >;
      small: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      source: Fjsx.DetailedHTMLProps<
        Fjsx.SourceHTMLAttributes<HTMLSourceElement>,
        HTMLSourceElement
      >;
      span: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLSpanElement>,
        HTMLSpanElement
      >;
      strong: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      style: Fjsx.DetailedHTMLProps<
        Fjsx.StyleHTMLAttributes<HTMLStyleElement>,
        HTMLStyleElement
      >;
      sub: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      summary: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      sup: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      table: Fjsx.DetailedHTMLProps<
        Fjsx.TableHTMLAttributes<HTMLTableElement>,
        HTMLTableElement
      >;
      tbody: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLTableSectionElement>,
        HTMLTableSectionElement
      >;
      td: Fjsx.DetailedHTMLProps<
        Fjsx.TdHTMLAttributes<HTMLTableDataCellElement>,
        HTMLTableDataCellElement
      >;
      textarea: Fjsx.DetailedHTMLProps<
        Fjsx.TextareaHTMLAttributes<HTMLTextAreaElement>,
        HTMLTextAreaElement
      >;
      tfoot: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLTableSectionElement>,
        HTMLTableSectionElement
      >;
      th: Fjsx.DetailedHTMLProps<
        Fjsx.ThHTMLAttributes<HTMLTableHeaderCellElement>,
        HTMLTableHeaderCellElement
      >;
      thead: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLTableSectionElement>,
        HTMLTableSectionElement
      >;
      time: Fjsx.DetailedHTMLProps<
        Fjsx.TimeHTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      title: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLTitleElement>,
        HTMLTitleElement
      >;
      tr: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLTableRowElement>,
        HTMLTableRowElement
      >;
      track: Fjsx.DetailedHTMLProps<
        Fjsx.TrackHTMLAttributes<HTMLTrackElement>,
        HTMLTrackElement
      >;
      u: Fjsx.DetailedHTMLProps<Fjsx.HTMLAttributes<HTMLElement>, HTMLElement>;
      ul: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLUListElement>,
        HTMLUListElement
      >;
      var: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      video: Fjsx.DetailedHTMLProps<
        Fjsx.VideoHTMLAttributes<HTMLVideoElement>,
        HTMLVideoElement
      >;
      wbr: Fjsx.DetailedHTMLProps<
        Fjsx.HTMLAttributes<HTMLElement>,
        HTMLElement
      >;
      webview: Fjsx.DetailedHTMLProps<
        Fjsx.WebViewHTMLAttributes<HTMLWebViewElement>,
        HTMLWebViewElement
      >;

      // SVG
      svg: Fjsx.SVGProps<SVGSVGElement>;

      animate: Fjsx.SVGProps<SVGElement>; // TODO: It is SVGAnimateElement but is not in TypeScript's lib.dom.d.ts for now.
      animateTransform: Fjsx.SVGProps<SVGElement>; // TODO: It is SVGAnimateTransformElement but is not in TypeScript's lib.dom.d.ts for now.
      circle: Fjsx.SVGProps<SVGCircleElement>;
      clipPath: Fjsx.SVGProps<SVGClipPathElement>;
      defs: Fjsx.SVGProps<SVGDefsElement>;
      desc: Fjsx.SVGProps<SVGDescElement>;
      ellipse: Fjsx.SVGProps<SVGEllipseElement>;
      feBlend: Fjsx.SVGProps<SVGFEBlendElement>;
      feColorMatrix: Fjsx.SVGProps<SVGFEColorMatrixElement>;
      feComponentTransfer: Fjsx.SVGProps<SVGFEComponentTransferElement>;
      feComposite: Fjsx.SVGProps<SVGFECompositeElement>;
      feConvolveMatrix: Fjsx.SVGProps<SVGFEConvolveMatrixElement>;
      feDiffuseLighting: Fjsx.SVGProps<SVGFEDiffuseLightingElement>;
      feDisplacementMap: Fjsx.SVGProps<SVGFEDisplacementMapElement>;
      feDistantLight: Fjsx.SVGProps<SVGFEDistantLightElement>;
      feFlood: Fjsx.SVGProps<SVGFEFloodElement>;
      feFuncA: Fjsx.SVGProps<SVGFEFuncAElement>;
      feFuncB: Fjsx.SVGProps<SVGFEFuncBElement>;
      feFuncG: Fjsx.SVGProps<SVGFEFuncGElement>;
      feFuncR: Fjsx.SVGProps<SVGFEFuncRElement>;
      feGaussianBlur: Fjsx.SVGProps<SVGFEGaussianBlurElement>;
      feImage: Fjsx.SVGProps<SVGFEImageElement>;
      feMerge: Fjsx.SVGProps<SVGFEMergeElement>;
      feMergeNode: Fjsx.SVGProps<SVGFEMergeNodeElement>;
      feMorphology: Fjsx.SVGProps<SVGFEMorphologyElement>;
      feOffset: Fjsx.SVGProps<SVGFEOffsetElement>;
      fePointLight: Fjsx.SVGProps<SVGFEPointLightElement>;
      feSpecularLighting: Fjsx.SVGProps<SVGFESpecularLightingElement>;
      feSpotLight: Fjsx.SVGProps<SVGFESpotLightElement>;
      feTile: Fjsx.SVGProps<SVGFETileElement>;
      feTurbulence: Fjsx.SVGProps<SVGFETurbulenceElement>;
      filter: Fjsx.SVGProps<SVGFilterElement>;
      foreignObject: Fjsx.SVGProps<SVGForeignObjectElement>;
      g: Fjsx.SVGProps<SVGGElement>;
      image: Fjsx.SVGProps<SVGImageElement>;
      line: Fjsx.SVGProps<SVGLineElement>;
      linearGradient: Fjsx.SVGProps<SVGLinearGradientElement>;
      marker: Fjsx.SVGProps<SVGMarkerElement>;
      mask: Fjsx.SVGProps<SVGMaskElement>;
      metadata: Fjsx.SVGProps<SVGMetadataElement>;
      path: Fjsx.SVGProps<SVGPathElement>;
      pattern: Fjsx.SVGProps<SVGPatternElement>;
      polygon: Fjsx.SVGProps<SVGPolygonElement>;
      polyline: Fjsx.SVGProps<SVGPolylineElement>;
      radialGradient: Fjsx.SVGProps<SVGRadialGradientElement>;
      rect: Fjsx.SVGProps<SVGRectElement>;
      stop: Fjsx.SVGProps<SVGStopElement>;
      switch: Fjsx.SVGProps<SVGSwitchElement>;
      symbol: Fjsx.SVGProps<SVGSymbolElement>;
      text: Fjsx.SVGProps<SVGTextElement>;
      textPath: Fjsx.SVGProps<SVGTextPathElement>;
      tspan: Fjsx.SVGProps<SVGTSpanElement>;
      use: Fjsx.SVGProps<SVGUseElement>;
      view: Fjsx.SVGProps<SVGViewElement>;
    }
  }
}
