...
export declare const initCompute: (fn: () => any, ...args: FJsxValue<any>[]) => FJsxValue<any>;
export declare const setCompute: (prev: FJsxValue<any>, fn: () => void, ...args: FJsxValue<any>[]) => FJsxValue<any>;
